...
import OrganizationDetails from "./component/organization-detail";
...
const OrganisationSetting = () => {
    ...
    return (
        <main className="flex min-h-screen flex-col justify-between bg-white">
                    ...
                    <div>
                        ...
                        <div className="pl-20 pr-20 pt-5 flex flex-col md:flex-row">
                            <div className="w-full md:w-1/2 p-5">
                                ...
                                {ClickableMenu('Users', 'Add, remove or modify users of this organisation', () => onClickUsers())}
                                {ClickableMenu('Organizations', 'Add and manage your list of organizations', () => onClickOrganizations())}
                            </div>
                            <div className="w-full md:w-1/2 p-5">
                                <p className="mb-5">General</p>
            ...
            {
                show === 'Users' ? (
                    <><Users onBack={() => setShow('setting')} /></>
                ) : null
            }
            {
                show === 'Organizations' ? (
                    <><Organizations onBack={() => setShow('setting')} ></Organizations></>
                ) : null
            }
        </main>
    )
