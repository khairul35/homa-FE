...
const Component = (props: Props) => {
    const { onBack, onBackToMain, updateUser, onSave, user, numberOfUser, error } = props;
            ...
            <div className="mt-0 p-10 pl-20 pr-20">
                <div className={styles.card}>
                    ...
                    <div className="p-5 flex justify-center">
                        ...
                        {/* First Name */}
                            <div className="w-full md:w-[calc(50%-10px)]"> {/* Adjust width for small screens */}
                            ...
                            />
                            {
                                user?.id ? <></>
                                : <>
                                    <label className="label mt-2">Password{user?.id}</label>
                                    <input
                                        value={user?.password || ''}
                                        onChange={(e) => updateUser({
