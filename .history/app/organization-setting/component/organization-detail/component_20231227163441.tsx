...
const Component = (props: Props) => {
    const { onBack, onSave, updateDetail, detail, error } = props;

    const RenderError = () => {
        return error ? (
            <div className="text-red-600 bg-red-200">{error}</div>
        ) : (
            <></>
        );
    };
    ...
    return (
        <div className="bg-bg-color min-h-screen overflow-auto pb-5">
            ...
            <footer className="fixed bottom-0 w-full bg-white shadow-md border-t border-gray-300 px-5 py-2 flex justify-between items-center">
