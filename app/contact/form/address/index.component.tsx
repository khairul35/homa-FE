        ...
        if (contact?.isBillingSameAsDelivery) {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 30" fill="none">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M21.6894 9C21.3155 9 20.9817 9.14689 20.7413 9.38727L12.3416 17.8003L9.28354 14.7289C9.04316 14.4885 8.70931 14.3416 8.3354 14.3416C7.60093 14.3416 7 14.9425 7 15.677C7 16.0509 7.14689 16.3848 7.38727 16.6251L11.3935 20.6313C11.6338 20.8717 11.9677 21.0186 12.3416 21.0186C12.7155 21.0186 13.0494 20.8717 13.2897 20.6313L22.6376 11.2835C22.8779 11.0432 23.0248 10.7093 23.0248 10.3354C23.0248 9.60093 22.4239 9 21.6894 9Z" fill="white"/>
                </svg>
            );
            }
                ...
                <form method="dialog">
                    <div className={styles.addressContainer}>
                        ...
                        <input
                            ...
                            value={contact?.contactBillingAddress?.attention || ''}
                            onChange={(e) => {
                                handleContactAddressesChange({
                                    contactBillingAddress: {
                                        attention: e.target.value,
                                        addressLine1: contact?.contactBillingAddress?.addressLine1 || '',
                                        
                                })
                            }}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.attention', e.target.value)}
                        />
                        ...
                        <input
                            ...
                            className={labelClass}
                            value={contact?.contactBillingAddress?.addressLine1 || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.addressLine1', e.target.value)}
                        />
                        <input
                            placeholder="Address Line 2"
                            className={`mt-3 ${labelClass}`}
                            value={contact?.contactBillingAddress?.addressLine2 || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.addressLine2', e.target.value)}
                        />
                        <div className="flex flex-wrap justify-center md:justify-start gap-5">
                            <div className="w-full md:w-[calc(50%-10px)]">
                                ...
                                <input
                                    placeholder="City"
                                    className={labelClass}
                                    value={contact?.contactBillingAddress?.city || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.city', e.target.value)}
                                />
                            </div>
                            <div className="w-full md:w-[calc(50%-10px)]">
                                ...
                                <input
                                    placeholder="State"
                                    className={labelClass}
                                    value={contact?.contactBillingAddress?.state || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.state', e.target.value)}
                                />
                            </div>
                        </div>
                        <div className="flex flex-wrap justify-center md:justify-start gap-5">
                            <div className="w-full md:w-[calc(50%-10px)]">
                                ...
                                <input
                                    ...
                                    className={labelClass}
                                    value={contact?.contactBillingAddress?.postalCode || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.postalCode', e.target.value)}
                                />
                            </div>
                            <div className="w-full md:w-[calc(50%-10px)]">
                                <label className="label mt-5">Country</label>
                                    <select
                                        placeholder="Country"
                                        className={labelClass}
                                        value={contact?.contactBillingAddress?.country || ''}
                            onChange={(e) => handleContactAddressesChange('contactBillingAddress.country', e.target.value)}
                                    >
                                        {
                                            countries.map((e) => (
                        ...
                        <div
                            className={styles.billingIsDeliveryCheckBox}
                            onClick={handleUseAsDeliverAddressChange}
                        >
                    ...
                    <div className={styles.addressContainer}>
                        ...
                        <input
                            placeholder="Attention to"
                            className={labelClass}
                            value={contact?.contactDeliveryAddress?.attention || ''}
                            onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.attention', e.target.value)}
                        />
                        ...
                        <input
                            placeholder="Address Line 1"
                            className={labelClass}
                            value={contact?.contactDeliveryAddress?.addressLine1 || ''}
                            onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.addressLine1', e.target.value)}
                        />
                        <input
                            placeholder="Address Line 2"
                            className={`mt-3 ${labelClass}`}
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-5">
                            <div className="w-full md:w-[calc(50%-10px)]">
                                ...
                                <input
                                    placeholder="City"
                                    className={labelClass}
                                    value={contact?.contactDeliveryAddress?.city || ''}
                                    onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.city', e.target.value)}
                                />
                            </div>
                            <div className="w-full md:w-[calc(50%-10px)]">
                                <label className="label mt-5">State</label>
                                <input
                                    placeholder="State"
                                    className={labelClass}
                                    value={contact?.contactDeliveryAddress?.state || ''}
                                    onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.state', e.target.value)}
                                />
                            </div>
                        </div>
                        <div className="flex flex-wrap justify-center md:justify-start gap-5">
                            <div className="w-full md:w-[calc(50%-10px)]">
                                ...
                                <input
                                    placeholder="Zip City"
                                    className={labelClass}
                                    value={contact?.contactDeliveryAddress?.postalCode || ''}
                                    onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.postalCode', e.target.value)}
                                />
                            </div>
                            <div className="w-full md:w-[calc(50%-10px)]">
                                <label className="label mt-5">Country</label>
                                    <select
                                        placeholder="Country"
                                        className={labelClass}
                                        value={contact?.contactDeliveryAddress?.country || ''}
                                        onChange={(e) => handleContactAddressesChange('contactDeliveryAddress.country', e.target.value)}
                                    >
                                        {
                                            countries.map((e) => (
                                                <option key={e.isoCode} value={e.name}>
